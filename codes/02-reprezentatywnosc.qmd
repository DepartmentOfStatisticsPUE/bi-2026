...
Interpretacja: brak wyraźnej zależności malejącej -- większa próba nie gwarantuje mniejszego błędu. To empiryczna ilustracja paradoksu big data Menga: przy autoselekcji zwiększanie $n$ nie redukuje obciążenia.
...
- **Kółka (Unadjusted)** -- wiele zmiennych przekracza próg 0.1, co potwierdza brak reprezentatywności CBOP.
- **Trójkąty (Adjusted)** -- po ważeniu punkty powinny przesunąć się w lewo, poniżej progu 0.1.
